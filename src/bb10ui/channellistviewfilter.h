...
#ifndef CHANNELLISTVIEWFILTER_H_
#define CHANNELLISTVIEWFILTER_H_
...
class ChannelListViewFilter : public QSortFilterProxyModel
{
    Q_OBJECT
...
public:
    ...
    ChannelListViewFilter(QAbstractItemModel *model, BufferViewConfig *config = 0);
...
Q_DECLARE_OPERATORS_FOR_FLAGS(ChannelListViewFilter::Modes)

#endif // CHANNELLISTVIEWFILTER_H_
