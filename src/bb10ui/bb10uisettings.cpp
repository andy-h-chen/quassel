...
Bb10UiSettings::Bb10UiSettings(const QString &subGroup)
    : UiSettings(QString("QtUi/%1").arg(subGroup))
{
}


Bb10UiSettings::Bb10UiSettings()
    : UiSettings("QtUi")
{
}
...
/***********************************************************************/
Bb10UiStyleSettings::Bb10UiStyleSettings(const QString &subGroup)
    : UiSettings(QString("QtUiStyle/%1").arg(subGroup))
{
}


Bb10UiStyleSettings::Bb10UiStyleSettings()
