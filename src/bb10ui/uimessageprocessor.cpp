...
UiMessageProcessor::UiMessageProcessor(QObject *parent)
...
void UiMessageProcessor::process(Message &msg)
{
...
void UiMessageProcessor::process(QList<Message> &msgs)
{
...
void UiMessageProcessor::startProcessing()
{
    if (processMode() == TimerBased) {
...
void UiMessageProcessor::processNextMessage()
{
...
void UiMessageProcessor::checkForHighlight(Message &msg)
{
...
void UiMessageProcessor::nicksCaseSensitiveChanged(const QVariant &variant)
{
    _nicksCaseSensitive = variant.toBool();
}


void UiMessageProcessor::highlightListChanged(const QVariant &variant)
{
...
void UiMessageProcessor::highlightNickChanged(const QVariant &variant)
{
